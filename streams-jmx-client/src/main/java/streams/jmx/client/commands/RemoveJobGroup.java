...
@Parameters(commandDescription = Constants.DESC_REMOVEJOBGROUP)
public class RemoveJobGroup extends AbstractInstanceCommand {
    ...
    public RemoveJobGroup() {
    }

    @Override
    public String getName() {
        return (Constants.CMD_REMOVEJOBGROUP);
    }

    @Override
    public String getHelp() {
        return (Constants.DESC_REMOVEJOBGROUP);
    }
    ...
    protected CommandResult doExecute() {
        try {
            ...
            instance.deleteJobGroup(jobgroup);

            jsonOut.put("jobgroup",jobgroup);
            jsonOut.put("result","deleted");

...
public class Constants {
	...
	public static final String
		...
		CMD_LISTJOBGROUP = "lsjobgroup",
		CMD_LISTJOBS = "lsjobs",
		CMD_LISTPES = "lspes",
		CMD_LISTRESOURCETAGS = "lstag",
		CMD_MAKEJOBGROUP = "mkjobgroup",
		CMD_MAKERESOURCETAG = "mktag",
		CMD_REMOVERESOURCETAG = "rmtag",
		CMD_REMOVEPROPERTY = "rmproperty",
		CMD_REMOVEJOBGROUP = "rmjobgroup",
	...
	public static final String
		...
		DESC_LISTJOBGROUP = "List job groups",

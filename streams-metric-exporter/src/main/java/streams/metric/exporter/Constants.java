...
public class Constants {
	...
	public static final String
		...
		ENV_JMX_HTTP_HOST = "STREAMS_EXPORTER_JMX_HTTP_HOST",
		ENV_JMX_HTTP_PORT = "STREAMS_EXPORTER_JMX_HTTP_PORT",
	...
	public static final String
		...
		DESC_JMX_HTTP_HOST = "Host or IP used to replace jmx http large data set URL host fields.  Not usually needed. Use with caution.      Environment Variabler: " + ENV_JMX_HTTP_HOST,
		DESC_JMX_HTTP_PORT = "Port used to replace jmx http large data set URL port fields.  Not usually needed. Use with caution.      Environment Variabler: " + ENV_JMX_HTTP_PORT,
